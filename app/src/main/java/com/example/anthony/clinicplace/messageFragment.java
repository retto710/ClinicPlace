...
public class messageFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        Button submit = (Button)v.findViewById(R.id.Consultar);
        ...
        searchView.setOnQueryTextListener(new SearchView.OnQueryTextListener() {
            ...
            public boolean onQueryTextSubmit(String s) {
                ...
                Fragment nuevoFragmento = new ClinicFragment();
                Bundle args = new Bundle();
                args.putString("Nombre",s);
                nuevoFragmento.setArguments(args);
                FragmentTransaction transaction = getFragmentManager().beginTransaction();
                transaction.replace(R.id.fragmento, nuevoFragmento);
        ...
        submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Fragment nuevoFragmento = new DateFragment();
                FragmentTransaction transaction = getFragmentManager().beginTransaction();
